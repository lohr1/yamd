...
int main(int argc, char *argv[]) {
    // USING CUTOFF LJ (as opposed to milestone 5):
    ...
    double cutoff = 2 * sigma;

    // Calc forces, store in atoms. Also calc energies.
    double PE = lj_cutoff_summation(atoms, cutoff, epsilon, sigma);
    ...
    // Trajectory file:
    std::string dir = "/home/robin/School/yamd/cmake-build-release/milestones/06/";
    ...
    for (int i = 0; i < nb_steps; ++i) {
        ...
        PE = lj_cutoff_summation(atoms, cutoff, epsilon, sigma);
